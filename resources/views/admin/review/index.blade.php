    ...
    <div class="col-md-10">
        <div class="card shadow mb-4">
            ...
            <div class="collapse show" id="listkriteria">
                <div class="card-body">
                    <a href="{{route('review.create')}}" class="btn btn-primary mb-3" >Tambah Data</a>
                        ...
                        <table class="table table-striped table-hover" id="DataTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$row->rating}}</td>
                                    <td>
                                        <a href="{{route('review.edit',$row->id)}}" class="btn btn-sm btn-circle btn-warning"><i class="fa fa-edit"></i></a>
                                        <a href="{{route('review.destroy',$row->id)}}" class="btn btn-sm btn-circle btn-danger hapus"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
